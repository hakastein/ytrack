...
exports.command = {
  ...
  flags: [
    ...
    { name: "visible-for", type: "string", multiple: true, usage: "`group` that sees the tag; repeatable" },
    { name: "updateable-by", type: "string", multiple: true, usage: "`group` that may edit the tag; repeatable" },
    { name: "taggable-by", type: "string", multiple: true, usage: "`group` that may tag with it; repeatable" },
