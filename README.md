...
Все команды имеют вид `ytrack <сущность> <действие>`:
...
Подробное описание каждой команды — в `ytrack <сущность> <действие> --help`.
...
Каждая команда печатает в stdout один YAML-документ. `show` выводит сущность
...
`ytrack completion <оболочка>` печатает скрипт автодополнения сущностей, действий,
